                    ...
                    <div class="">
                        <div class="row mx-5" >
                            <div class="col-12 mt-5">
                                ...
                                <input type="text" name='title' class="form-control" style="height: 50px">
                            </div>
                            @error('title')
                        ...
                        <div class="row mx-5" >
                            ...
                            <div class="col-4 mt-4">
                                ...
                                <input type="text" name="author_name" class="form-control" style="height: 50px">
                                @error('author_name')
                                    <div class="text-danger ms-1">{{ $message }}</div>
                                 @enderror
                            </div>
                            <div class="col-4 mt-4">
                                ...
                                <input type="file" name='hero_image' class="form-control form-control-lg" >
                                @error('hero_image')
                                    <div class="text-danger ms-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mx-5" id='addMoreArticle'>
                            <span class="article">
                                <div class="col-12 mt-4">
                                    ...
                                    <textarea name="content[0]" class="form-control" rows="15" style="resize: none"></textarea>
                                    @error('content.*')
                                        <div class="text-danger ms-1">{{ $message }}</div>
                                    @enderror
                                </div>
